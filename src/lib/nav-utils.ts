export function isActive(pathname: string, href: string): boolean {
  switch (href) {
    case '/':
      ...
      return pathname === '/' || pathname.startsWith('/project/') || /^\/foundation\/[^/]+/.test(pathname) || pathname.startsWith('/website/') || pathname.startsWith('/content/');
    case '/ideas/new':
    ...
    case '/analytics':
      ...
      // But NOT per-project analytics (/project/[id]/analytics)
