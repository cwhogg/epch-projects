export function CheckCircleIcon({ color = 'var(--accent-emerald)' }: { color?: string }) {
  return (
...
export function EmptyCircleIcon({ color = 'var(--text-muted)' }: { color?: string }) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function ReadyCircleIcon() {
  return (
