...
function PropertySelectorWithHelper({
  properties,
  selectedProperty,
  onSelectProperty,
  onRefresh,
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-2" style={{ color: 'var(--text-secondary)' }}>
            <li>
              ...
              {' '}and click <strong>Add property</strong>
            </li>
            <li>Choose <strong>URL prefix</strong> and enter your site URL</li>
            <li>Verify ownership (HTML tag, DNS, or file upload)</li>
            <li>
              In <strong>Settings → Users and permissions</strong>, add this service account as a <strong>Full</strong> user:
              <div className="mt-1.5 p-2 rounded flex items-center gap-2" style={{ background: 'var(--bg-default)' }}>
                ...
                <button
                  onClick={() => navigator.clipboard.writeText('epch-research-dashboard@epch-research-dashboard.iam.gserviceaccount.com')}
            ...
            <li>Click <strong>Refresh</strong> above — your new property will appear in the dropdown</li>
          </ol>
        </div>
      )}
    </div>
...
function GSCSetupChecklist({ onRefresh }: { onRefresh: () => Promise<void> }) {
