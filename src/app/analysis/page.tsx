    ...
    <div className="space-y-8 sm:space-y-12">
      ...
      <header className="animate-slide-up stagger-1 relative">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/ideas/new" className="btn btn-primary text-sm shrink-0">
              ...
              {analyses.map((analysis, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between gap-2 mb-4 overflow-x-auto pb-1">
                    <ScoreRing score={analysis.scores.competitiveLandscape} label="Comp" />
                    <ScoreRing score={analysis.scores.willingnessToPay} label="WTP" />
                    <ScoreRing score={analysis.scores.differentiationPotential} label="Diff" />
